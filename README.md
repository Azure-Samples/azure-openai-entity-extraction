...
* [Extract entities using Azure OpenAI structured outputs mode](https://learn.microsoft.com/en-us/azure/developer/ai/how-to/extract-entities-using-structured-outputs?tabs=github-codespaces): The Microsoft Learn how-to article for this sample, walks through both deployment and all the code for each example.
